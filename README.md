...
See [ACP Sessions](docs/acp.md) for the workflow, [Configuration Reference](docs/configuration.md#acp-sessions) for the config shape, and [ACP Tools](docs/tools/acp.md) for the agent-facing tool reference.
