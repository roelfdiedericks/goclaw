...
var managedModelCatalog = []ManagedModelSpec{
	...
	},
	{
		...
		Family:                 ModelFamilyQwenCoder,
		Label:                  "Qwen3 Coder 30B A3B (Q2_K, smallest)",
		HFRepo:                 "mradermacher/Qwen3-Coder-30B-A3B-Instruct-GGUF",
		PreferredQuant:         "Q2_K",
		PreferredFilename:      "Qwen3-Coder-30B-A3B-Instruct.Q2_K.gguf",
		MMProjFilename:         "",
		ApproxDownloadBytes:    11258612480,
		RecommendedMinRAMBytes: 16 * 1024 * 1024 * 1024,
		FallbackContextTokens:  256 * 1024,
	},
	{
		ID:                     "qwen3-coder-30b-a3b-q3-k-s",
		Family:                 ModelFamilyQwenCoder,
		Label:                  "Qwen3 Coder 30B A3B (Q3_K_S, small)",
		HFRepo:                 "mradermacher/Qwen3-Coder-30B-A3B-Instruct-GGUF",
		PreferredQuant:         "Q3_K_S",
		PreferredFilename:      "Qwen3-Coder-30B-A3B-Instruct.Q3_K_S.gguf",
		MMProjFilename:         "",
		ApproxDownloadBytes:    13292471040,
		RecommendedMinRAMBytes: 18 * 1024 * 1024 * 1024,
		FallbackContextTokens:  256 * 1024,
	},
	{
		ID:                     "qwen3-coder-30b-a3b-q4-k-s",
		Family:                 ModelFamilyQwenCoder,
		Label:                  "Qwen3 Coder 30B A3B (Q4_K_S, recommended)",
		HFRepo:                 "mradermacher/Qwen3-Coder-30B-A3B-Instruct-GGUF",
		PreferredQuant:         "Q4_K_S",
		PreferredFilename:      "Qwen3-Coder-30B-A3B-Instruct.Q4_K_S.gguf",
		MMProjFilename:         "",
		ApproxDownloadBytes:    17456012032,
		RecommendedMinRAMBytes: 24 * 1024 * 1024 * 1024,
		FallbackContextTokens:  256 * 1024,
	},
	{
		...
		Family:                 ModelFamilyQwenCoder,
		Label:                  "Qwen3 Coder 30B A3B (Q4_K_M, recommended+)",
		HFRepo:                 "mradermacher/Qwen3-Coder-30B-A3B-Instruct-GGUF",
		PreferredQuant:         "Q4_K_M",
		PreferredFilename:      "Qwen3-Coder-30B-A3B-Instruct.Q4_K_M.gguf",
		MMProjFilename:         "",
		ApproxDownloadBytes:    18556689152,
		RecommendedMinRAMBytes: 24 * 1024 * 1024 * 1024,
		FallbackContextTokens:  256 * 1024,
	},
}
