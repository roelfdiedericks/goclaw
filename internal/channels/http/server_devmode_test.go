...
func TestResolveDevTemplatesDirUsesCurrentWorkingDirectory(t *testing.T) {
	repoRoot := t.TempDir()
...
func TestResolveDevTemplatesDirExplainsRepoRootExpectation(t *testing.T) {
	...
	if !strings.Contains(err.Error(), "current working directory to be the GoClaw repo root") {
